...
<html>
<head>
	<title>Welcome to MooiDunia</title>
		...
		<div class="login_box">
			...
			<div id="second">
				...
				<form action="register.php" method="POST">
					...
					?>" required>
					<br>
					<?php if (in_array("Your last name should be between 2 and 25 characters", $error_array)) {
					...
					<br>
					<?php if (in_array("Your passwords do not match<br>", $error_array)) echo "Your passwords don't match<br>"; 
